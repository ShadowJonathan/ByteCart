...
final class BC7015 extends BC7011 implements Triggable {
    ...
    protected void infoPlayer(String address) {
        ((Player) this.getInventory().getHolder()).sendMessage(ChatColor.DARK_GREEN + "[Bytecart] " + ChatColor.YELLOW + ByteCart.plugin.getConfig().getString("Info.SetReturnAddress") + " " + ChatColor.RED + address);
    }
}
