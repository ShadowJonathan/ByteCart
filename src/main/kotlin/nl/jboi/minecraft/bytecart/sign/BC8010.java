...
public class BC8010 extends AbstractTriggeredSign implements BCRouter, Triggable, HasRoutingTable {
    ...
    public void trigger() {
        ...
        try {
            ...
            Router router = ByteCart.plugin.getCollisionAvoiderManager().getCollisionAvoider(builder);
...
// is this an wanderer who needs special routing ? no then routing normally
            if (selectWanderer()) {
                ...
                if (this.wasTrain(this.getLocation())) {
                    ...
                    ByteCart.plugin.getCollisionAvoiderManager().<Router>getCollisionAvoider(builder).Book(isTrain);
                    return;
                }
...
// if this is the first car of a train
            ...
            if (ByteCart.plugin.getWandererManager().isWanderer(getInventory(), "Updater")) {
    ...
    protected boolean selectWanderer() {
        ...
        return !ByteCart.plugin.getWandererManager().isWanderer(getInventory());
    }
    ...
    private Wanderer getWanderer() throws ClassNotFoundException, IOException {
        return ByteCart.plugin.getWandererManager().getFactory(this.getInventory()).getWanderer(this, this.getInventory());
    }
