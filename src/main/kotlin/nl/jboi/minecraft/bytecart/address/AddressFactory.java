...
public class AddressFactory {
    ...
    public static <T extends Address> T getDefaultTicket(Inventory inv) {
        ...
        if (inv.getHolder() instanceof Player) {
            destination = ByteCart.plugin.getConfig().getString("PlayersNoTicketDefaultRoute", "0.0.0");
            ...
            destination = ByteCart.plugin.getConfig().getString("EmptyCartsDefaultRoute", "0.0.0");
