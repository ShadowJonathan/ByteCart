...
public final class TriggeredSignFactory {
     ...
     * @throws IOException
     */
    public static Triggable getTriggeredIC(Block block, Vehicle vehicle) {
     ...
     * @throws IOException
     */
    public static Triggable getTriggeredIC(Block block, String signString, Vehicle vehicle) {
